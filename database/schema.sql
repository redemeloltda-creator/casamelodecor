...
-- Tabela para cadastro de clientes (formulário Nome + Email).
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE schemaname = 'public' AND tablename = 'usuarios' AND policyname = 'usuarios_insert'
  ) THEN
...
GRANT SELECT, INSERT ON usuarios TO anon, authenticated;
